...
public class GetColorByIdUseCase {
    ...
    public GetColorByIdUseCase(ElasticsearchClient esClient) {
    ...
    public RefDocument execute(Long id) {
        try {
            ...
            if (!indexExists) throw new ResourceNotFoundException("color not found: " + id);
            ...
            throw new QueryException("Elasticsearch get failed for color: " + id, e);
        }
    }
}

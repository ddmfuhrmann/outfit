...
@Slf4j
@Service
public class IndexSizeUseCase {

    private static final String INDEX = "sizes";

    private final ElasticsearchClient esClient;

    public IndexSizeUseCase(ElasticsearchClient esClient) {
    ...
    public void execute(Long id, String description) {
        try {
            ...
            log.info("Indexed size {}", id);
        } catch (IOException e) {
            throw new IndexingException("Failed to index size " + id, e);
        }
    }
}

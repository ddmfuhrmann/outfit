...
@Service
public class GetSizeByIdUseCase {

    private static final String INDEX = "sizes";

    private final ElasticsearchClient esClient;

    public GetSizeByIdUseCase(ElasticsearchClient esClient) {
    ...
    public RefDocument execute(Long id) {
        try {
            ...
            if (!indexExists) throw new ResourceNotFoundException("size not found: " + id);
            ...
            throw new QueryException("Elasticsearch get failed for size: " + id, e);
        }
    }
}

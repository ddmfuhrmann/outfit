...
@Slf4j
@Service
public class IndexColorUseCase {

    private static final String INDEX = "colors";

    private final ElasticsearchClient esClient;

    public IndexColorUseCase(ElasticsearchClient esClient) {
    ...
    public void execute(Long id, String description) {
        try {
            ...
            log.info("Indexed color {}", id);
        } catch (IOException e) {
            throw new IndexingException("Failed to index color " + id, e);
        }
    }
}

...
@Service
public class SearchColorsUseCase {

    private static final String INDEX = "colors";

    private final ElasticsearchClient esClient;

    public SearchColorsUseCase(ElasticsearchClient esClient) {
    ...
    public PageResponse<RefDocument> execute(String q, Pageable pageable) {
        ...
        try {
            ...
            throw new QueryException("Elasticsearch search failed for colors", e);
        }
    }
